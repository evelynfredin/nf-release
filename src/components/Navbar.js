...
const Navbar = () => {
    ...
    const scrtollToTop = () => window.scrollTo({ top: 0, behavior: 'smooth' });
    ...
    return (
        ...
        transition={{ ease: "easeOut", duration: 1 }}
            ...
            <nav className="wrapper flex justify-between h-auto items-center">
                <button aria-label="Scroll to the top" className="cursor-pointer border-none focus:outline-none" onClick={scrtollToTop} >
